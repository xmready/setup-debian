...
nnoremap <silent> <Leader>t :execute empty($TMUX) ? 'terminal ++close ++norestore' : 'silent !tmux split-window -v'<CR>
nnoremap <silent> <Leader>T :execute empty($TMUX) ? 'vertical terminal ++close ++norestore' : 'silent !tmux split-window -h'<CR>
...
g:ale_fix_on_save = 1
g:ale_kotlin_ktlint_options = '--log-level=none'
g:ale_fixers = {
...
# Fugitive {{{
nnoremap <silent> <Leader>f :0Git<CR>
nnoremap <silent> <Leader>F :Gdiffsplit!<CR>
nnoremap <silent> <Leader>S :Gwrite<CR>
# }}}
...
augroup FuzzboxResize
    autocmd!
    autocmd BufEnter,WinEnter,WinNew,VimResized * g:fuzzbox_window_defaults = &columns > 120 ? { 'width': 0.95 } : { 'width': 0.9, 'height': 0.7, 'preview': 0 }
augroup END
# }}}
...
nnoremap <silent> yog       :GitGutterSignsToggle<Bar>set number! norelativenumber<CR>
nnoremap <silent> <Leader>g :GitGutterFold<CR>
...
# tmux normal maps non-recursive
...
# tmux terminal maps non-recursive
tnoremap <silent> <Left>  <C-W>:<C-U>TmuxNavigateLeft<CR>
tnoremap <silent> <Down>  <C-W>:<C-U>TmuxNavigateDown<CR>
tnoremap <silent> <Up>    <C-W>:<C-U>TmuxNavigateUp<CR>
tnoremap <silent> <Right> <C-W>:<C-U>TmuxNavigateRight<CR>
# }}}
...
# Yank to Clipboard {{{
augroup wlcopy_on_yank
  autocmd!
  autocmd TextYankPost * b:_ = v:event.regname ==# '0' ? system('wl-copy', getreg('"')) : ''
augroup END
# }}}
