...
11. Install [Homebrew](https://github.com/Homebrew/install)
...
13. Install verified [Flatpak](https://flatpak.org) apps
    - Firefox
    - GIMP
    - GnuCash
    - Kdenlive
    ...
    - Thunderbird
    - Ungoogled Chromium
14. Install and configure [OpenCode](https://github.com/anomalyco/opencode)
    - Install latest `opencode` version to current user
    - Download `tui.json` config file to `~/.config/opencode/`
15. Install custom commands in `~/bin/`
    - `autoupgrade` (requires sudo)
    - `temps`
    - `dnsleaktest`
16. Harden network security
    - Disable tcp timestamps
    - Set default firewall policy with `ufw`
    - Enable `ufw`
17. Reboot system after 10 minutes
