...
script_urls=(
  "https://raw.githubusercontent.com/xmready/setup-debian/main/scripts/setup-server-apt.sh"
  "https://raw.githubusercontent.com/xmready/setup-debian/main/scripts/setup-server-shell.sh"
  "https://raw.githubusercontent.com/xmready/vim-config/main/setup-server-vim.sh"
  "https://raw.githubusercontent.com/xmready/setup-debian/main/scripts/setup-apt-clean.sh"
  "https://raw.githubusercontent.com/xmready/setup-debian/main/scripts/setup-server-commands.sh"
  "https://raw.githubusercontent.com/xmready/setup-debian/main/scripts/setup-server-harden.sh"
)

# Declare checksum variables
sha256sums_url="https://github.com/xmready/setup-debian/releases/download/"$(get_latest_release xmready/setup-debian)"/SHA256SUMS_SERVER"
